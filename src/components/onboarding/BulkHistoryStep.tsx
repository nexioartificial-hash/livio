    ...
    return (
        <div className="h-full flex flex-col p-8 overflow-y-auto custom-scrollbar">
            <div className="space-y-2 mb-8">
                <h2 className="text-3xl font-black text-slate-900 dark:text-white">Historia Clínica y Odontograma</h2>
                <p className="text-slate-500 dark:text-slate-400 font-medium">Configuración masiva para tus pacientes importados.</p>
            </div>
            ...
            <div className="space-y-8 flex-1">
                ...
                <div className="space-y-4">
                    <h3 className="text-xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
                        <Activity className="text-accent" /> Odontograma Masivo
                    </h3>
                        ...
                        {templates.map(t => (
                            <button
                                ...
                                className={`p-6 rounded-[2rem] border-2 transition-all text-left space-y-2 ${selectedTemplate === t.id
                                        ...
                                        : "border-slate-50 bg-slate-50 dark:bg-slate-900/50 hover:bg-white dark:bg-slate-950"
                                    }`}
                            >
                                <div className="w-10 h-10 rounded-xl bg-white dark:bg-slate-950 flex items-center justify-center shadow-sm">
                                    {t.icon}
                                </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="p-8 border-2 border-dashed border-slate-100 dark:border-slate-800 rounded-[2.5rem] bg-slate-50 dark:bg-slate-900/30 text-center">
                        ...
                        <Button variant="outline" className="rounded-xl h-12 border-slate-200 dark:border-slate-700 font-bold gap-2">
                ...
                <div className="p-6 rounded-[2rem] bg-slate-900 text-white flex items-center gap-6">
                    <div className="w-14 h-14 rounded-2xl bg-white dark:bg-slate-950/10 flex items-center justify-center">
                    ...
                    <Button variant="outline" className="ml-auto rounded-xl border-white/20 text-white bg-white dark:bg-slate-950/5 hover:bg-white dark:bg-slate-950/10">
                        Configurar
                    </Button>
                </div>
            </div>
