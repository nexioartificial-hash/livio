...
export default function TermsPage() {
    ...
    return (
        <div className="min-h-screen bg-[#f8fafc] font-sans selection:bg-[#76D7B6]/30 selection:text-[#5cb99a]">
            <Header />

            {/* Subheader decorativo */}
            <header className="pt-32 pb-1 bg-white border-b border-slate-100">
                <div className="max-w-7xl mx-auto px-4 flex items-center gap-2 text-sm font-medium text-slate-400">
                    <Link href="/" className="hover:text-[#76D7B6] transition-colors">Inicio</Link>
            ...
            <main className="max-w-7xl mx-auto px-4 py-12 md:py-20">
                <div className="text-center mb-16">
                    <h1 className="text-4xl md:text-6xl font-extrabold text-slate-900 tracking-tight mb-4">
                        Términos y <span className="text-[#76D7B6]">Condiciones</span>
                    </h1>
                    <p className="text-slate-500 text-lg">
                        Última actualización: <span className="font-medium text-slate-900">4 de marzo de 2026</span>
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                                ...
                                <a
                                    ...
                                    className={cn(
                                        ...
                                        activeSection === item.id
                                            ? "border-l-[3px] border-[#76D7B6] bg-[#76D7B6]/5 font-semibold text-[#5cb99a]"
                    ...
                    <div className="lg:col-span-9 bg-white rounded-2xl border border-slate-200 p-8 md:p-12 shadow-sm">
                        <section className="mb-12" id="intro">
                            <div className="bg-[#76D7B6]/5 border-l-4 border-[#76D7B6] p-6 rounded-r-xl italic text-slate-700 leading-relaxed">
                        ...
                        <div className="prose prose-slate max-w-none space-y-16 text-slate-600">
                            <section id="definiciones">
                                <div className="flex items-center gap-3 mb-6 font-display text-slate-900">
                                    <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-[#76D7B6]/10 text-[#5cb99a] font-bold border border-[#76D7B6]/20">1</span>
                                    <h2 className="text-2xl font-bold m-0">Definiciones</h2>
                                </div>
                                <ul className="list-none p-0 space-y-4">
                                    <li className="flex items-start gap-3">
                                        <span className="material-symbols-outlined text-[#76D7B6] text-sm mt-1">circle</span>
                            ...
                            <section id="aceptacion">
                                <div className="flex items-center gap-3 mb-6 font-display text-slate-900">
                                    <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-[#76D7B6]/10 text-[#5cb99a] font-bold border border-[#76D7B6]/20">2</span>
                            ...
                            <section id="cuentas">
                                <div className="flex items-center gap-3 mb-6 font-display text-slate-900">
                                    <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-[#76D7B6]/10 text-[#5cb99a] font-bold border border-[#76D7B6]/20">3</span>
                            ...
                            <section id="suscripcion">
                                <div className="flex items-center gap-3 mb-6 font-display text-slate-900">
                                    <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-[#76D7B6]/10 text-[#5cb99a] font-bold border border-[#76D7B6]/20">4</span>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                    <div className="p-5 border border-slate-200 rounded-xl bg-slate-50">
                                        ...
                                        <p className="text-2xl font-extrabold text-slate-900">$99.000 <span className="text-sm font-normal text-slate-500">ARS/mes</span></p>
                                    </div>
                                    <div className="p-5 border border-slate-200 rounded-xl bg-slate-50">
                                        <h4 className="font-bold text-[#5cb99a] mb-2 uppercase text-xs tracking-widest">Prueba Gratis</h4>
                                        <p className="text-2xl font-extrabold text-slate-900">30 Días</p>
                                    </div>
                                </div>
                            ...
                            <section id="uso-permitido">
                                <div className="flex items-center gap-3 mb-6 font-display text-slate-900">
                                    <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-[#76D7B6]/10 text-[#5cb99a] font-bold border border-[#76D7B6]/20">5</span>
                            ...
                            <section id="propiedad-intelectual">
                                <div className="flex items-center gap-3 mb-6 font-display text-slate-900">
                                    <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-[#76D7B6]/10 text-[#5cb99a] font-bold border border-[#76D7B6]/20">6</span>
                            ...
                            <section id="datos-clinicos">
                                <div className="flex items-center gap-3 mb-6 font-display text-slate-900">
                                    <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-[#76D7B6]/10 text-[#5cb99a] font-bold border border-[#76D7B6]/20">7</span>
                            ...
                            <section id="garantias">
                                <div className="flex items-center gap-3 mb-6 font-display text-slate-900">
                                    <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-[#76D7B6]/10 text-[#5cb99a] font-bold border border-[#76D7B6]/20">8</span>
                            ...
                            <section id="responsabilidad">
                                <div className="flex items-center gap-3 mb-6 font-display text-slate-900">
                                    <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-[#76D7B6]/10 text-[#5cb99a] font-bold border border-[#76D7B6]/20">9</span>
                            ...
                            <section id="terminacion">
                                <div className="flex items-center gap-3 mb-6 font-display text-slate-900">
                                    <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-[#76D7B6]/10 text-[#5cb99a] font-bold border border-[#76D7B6]/20">11</span>
                            ...
                            <section id="disputas">
                                <div className="flex items-center gap-3 mb-6 font-display text-slate-900">
                                    <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-[#76D7B6]/10 text-[#5cb99a] font-bold border border-[#76D7B6]/20">13</span>
                        ...
                        <div className="mt-20 pt-10 border-t border-slate-200 flex flex-col md:flex-row items-center justify-between gap-6">
                            <div>
                                <p className="text-slate-500 text-sm">¿Deseas una copia de estos términos?</p>
                                <p className="text-slate-900 font-bold text-lg">support@livio.ar</p>
                            </div>
                            <button className="bg-[#76D7B6] hover:bg-[#5cb99a] text-white px-8 py-3 rounded-xl font-bold transition-all shadow-lg shadow-[#76D7B6]/20">
                                Descargar Términos
                            </button>
                        </div>
                    </div>
